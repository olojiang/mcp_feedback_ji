...
exports.RULES_CONTENT = void 0;
exports.planRulesDeploy = planRulesDeploy;
exports.RULES_CONTENT = [
    '---',
    'alwaysApply: true',
    '---',
    '',
...
function planRulesDeploy(existingGlobalContent, workspacePaths) {
    const writeGlobal = existingGlobalContent !== exports.RULES_CONTENT;
    const removeWorkspaceRules = workspacePaths.map((ws) => `${ws}/.cursor/rules/mcp-feedback-enhanced.mdc`);
